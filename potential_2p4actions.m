...
n_actions = 4; % number of actions per state
...
data1 = (q1_iter_mean(plot_ind,3));
data2 = (q2_iter_mean(plot_ind,3));
p1a3 = plot(iter_save_plot,movavg(data1,'exponential',w),'Color',C{3},'linewidth',2);
p2a3 = plot(iter_save_plot,movavg(data2,'exponential',w),'Color',C{n_actions+3},'linewidth',2);

data1 = (q1_iter(plot_ind,4));
data2 = (q2_iter(plot_ind,4));
p1a4 = plot(iter_save_plot,movavg(data1,'exponential',w),'Color',C{4},'linewidth',2);
p2a4 = plot(iter_save_plot,movavg(data2,'exponential',w),'Color',C{n_actions+4},'linewidth',2);
...
print(h,'pot2p4a','-dpdf','-r0')


toc

%% Saving
save results_pot_2p4a
